function gnss_solution = GNSS_KF(pseudo_ranges,pseudo_range_rates,satellite_numbers,satellite_count,times,epoch_num)
    % Calculates GNSS Kalman Filter estimation, saving solutions in GNSS_Solution.csv
    % Inputs:
    %   pseudo_ranges                 Array of pseudo range measurements
    %   pseudo_range_rates            Array of pseudo range rate measurements
    %   satellite_numbers             Array of satellite numbers
    %   satellite_count               Total count of satellites
    %   times                         Array of time value for each epoch
    %   epoch_num                     Total count of epochs
    %
    % Outputs:
